...
Just went through the Bruin playlist reviewing some of the features and capabilities Bruin has to offer. Very first impression is that it reminded me of dbt probably because of the work being yml-driven and the approach to seeds. I am taking the opportunity in this module to try out Cursor, MCP, and DuckDB. I am particularly intrested in DDB as I grew quite curious about it from the dbt module. 
...
**Comment:** This was the correct answer, as indicated in the Zoomcamp template shared by Bruin and Choosing the right incremental key. More info at https://github.com/bruin-data/bruin/tree/main/templates/zoomcamp > Best practices
...
**Comment**: Third option was the correct one, I chosen the fourth one. Bruin documentation on variables verifies --var 'taxi_types=["yellow"] is the way: https://getbruin.com/docs/bruin/core-concepts/variables.html > Overriding Variables at Runtime 
...
More info here: https://getbruin.com/docs/bruin/assets/materialization.html#full-refresh-and-refresh-restricted 
